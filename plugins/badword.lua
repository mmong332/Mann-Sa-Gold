...
local function addword(msg, name)
    ...
    return "اوك ضفـتهة للممـنوعات ☺️📍\n>"..name
end
...
local function list_variablesbad(msg)
  ...
  if hash then
    ...
    local text = 'قائـمه الممـنوعات ☺️📍:\n\n'
    for i=1, #names do
      text = text..'> '..names[i]..'\n'
    end
    return text
...
function clear_commandbad(msg, var_name)
  ...
  return 'اوك مسـحت قائمـه الممـنوعات ☺️📍'
end
...
function clear_commandsbad(msg, cmd_name)
  ...
  return ''..cmd_name..' اوك وخـرتهة مـن الممـنوعات ☺️📍'
end

local function run(msg, matches)
  if matches[2] == 'منع' then
  if not is_momod(msg) then
   return 'بـس للمـشرفين 🐸📍'
  end
